...
def battle_engine(hero):
    ...
    goblin = Character(name = "Chris Goblin", xp = 0, level = 1,
                   gold = 5, attack_power= 6,
                   defense = 3, max_hp = 7, hp = 7, weapon= "fists", inventory = ['rotten fish'])
    ghoul = Character(name = "Little Green Ghoul, Buddy!", xp = 0, level = 1,
    ...
    while in_fight:
        ...
        if action == "1":
            ...
            print(f"You flee the fight, leaving the f{enemy_encountered.name} howling at your back")
            in_fight = False
